...
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, Update, KeyboardButton, WebAppInfo
...
async def start(update: Update, context: CallbackContext.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton("Option 2", callback_data="3", web_app=WebAppInfo(url="https://iiiklox.github.io/KaizouBot/")),
